...
import { CATEGORY_VAKTSYNATSIYA, transformPost } from '@/lib/wp-transform.mjs';
...
export const metadata = {
  title: 'Вакцинація від COVID-19 — Уманська центральна районна лікарня',
  description: 'Матеріали КНП «Уманська ЦРЛ» про вакцинацію від COVID-19: актуальні новини, карантинні норми, інформація про щеплення.',
};

const PER_PAGE = 12;
const BASE_PATH = '/vaktsynatsiya-vid-covid-19';
...
export default async function VaktsynatsiyaPage({ searchParams }) {
  ...
  try {
    const result = await fetchPosts(
      {
        categoryIds: [CATEGORY_VAKTSYNATSIYA],
        page,
        perPage: PER_PAGE,
        search: q,
    ...
    console.error('Failed to load vaktsynatsiya-vid-covid-19 from uman.crl.net.ua:', err);
    loadError = true;
  }
      ...
      <section className="page-header-section relative pt-40 pb-16 lg:pt-48 lg:pb-20 bg-gray-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 lg:px-10">
          <nav className="flex items-center gap-2 text-xs text-white/40 mb-6" aria-label="Хлібні крихти">
            ...
            <span>/</span>
            <span className="text-white/70">Вакцинація від COVID-19</span>
          </nav>
          <p className="text-xs font-semibold tracking-widest text-blue-400 uppercase mb-5">Профілактика та щеплення</p>
          <h1 className="text-4xl lg:text-5xl font-300 text-white leading-tight">
            Вакцинація <span className="font-600">від COVID-19</span>
          </h1>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-[10px] px-2.5 py-1 rounded-full font-semibold uppercase tracking-wide bg-indigo-100 text-indigo-700">
                        Вакцинація
                      </span>
