...
import { CATEGORY_PORADY, transformPost } from '@/lib/wp-transform.mjs';
...
export const metadata = {
  title: 'Поради лікаря — Уманська центральна районна лікарня',
  description: 'Поради лікарів КНП «Уманська ЦРЛ» Паланської територіальної громади: профілактика, здоровий спосіб життя, відповіді на поширені питання про здоров’я.',
};

const PER_PAGE = 12;
const BASE_PATH = '/porady-likarya';
...
export default async function PoradyLikaryaPage({ searchParams }) {
  ...
  try {
    ...
    console.error('Failed to load porady-likarya from uman.crl.net.ua:', err);
    loadError = true;
  }
      ...
      <section className="page-header-section relative pt-40 pb-16 lg:pt-48 lg:pb-20 bg-gray-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 lg:px-10">
          <nav className="flex items-center gap-2 text-xs text-white/40 mb-6" aria-label="Хлібні крихти">
            ...
            <span>/</span>
            <span className="text-white/70">Поради лікаря</span>
          </nav>
          <p className="text-xs font-semibold tracking-widest text-blue-400 uppercase mb-5">Профілактика та здоровий спосіб життя</p>
          <h1 className="text-4xl lg:text-5xl font-300 text-white leading-tight">
            Поради <span className="font-600">лікаря</span>
          </h1>
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          {loadError ? (
            <div className="text-center py-20">
              <p className="text-gray-500 mb-4">Не вдалося завантажити поради лікаря — сайт лікарні тимчасово недоступний.</p>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-[10px] px-2.5 py-1 rounded-full font-semibold uppercase tracking-wide bg-green-100 text-green-700">
                        Поради лікаря
                      </span>
